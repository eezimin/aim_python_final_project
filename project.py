...
if __name__ == '__main__':
    ...
    def set_time(msg):
        ...
        new_massage = f'Введите час (от 0 до 23), когда вы хотели бы получать уведомления'
    ...
    def time_from_user(msg):
        ...
        message_to_send = f'Вы установили время {str(time_for_not)}:00 для получения уведомлений'
        bot.send_message(msg.chat.id, message_to_send)
    ...
    def start_scheduling(msg):
        ...
        while True:
            ...
            if current_time.hour == target_time.hour and current_time.minute == target_time.minute:
                message_to_send = f'Сейчас {target_time.hour}:00. Самое время заняться английским!'
                bot.send_message(msg.chat.id, message_to_send)                
                sleep(61)
